...
function renderPlitaBlock(day,items){
    const rows=items.map((it,i)=>`
      <div class="prod-row">
        <input class="prod-inp prod-len" type="text" inputmode="decimal" placeholder="Uzunlik"
          value="${it.length||''}"
        ...
        <input class="prod-inp prod-cnt" type="text" inputmode="numeric" placeholder="Dona"
          value="${it.count||''}"
      ...
      <div class="prod-cat-block">
        ...
        <div class="prod-rows">
          <div class="prod-row prod-row-blok">
            ...
            <input class="prod-inp prod-blok-cnt" type="text" inputmode="numeric" placeholder="Dona"
              value="${blok.count||''}"
